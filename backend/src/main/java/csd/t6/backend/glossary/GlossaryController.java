...
public class GlossaryController {
  ...
  @PutMapping("/")
  public void updateGlossaryTerm(@RequestBody GlossaryUpdateRequest request) {
    this.glossaryService.updateGlossaryTerm(request);
  }

  @DeleteMapping("/")
  public void clearGlossaryTerms() {
    this.glossaryService.clearGlossaryTerms();
  }
}
