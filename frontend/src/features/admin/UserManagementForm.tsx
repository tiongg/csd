        ...
        <div className="flex flex-col gap-4 py-4">
            <div className="flex gap-x-2 w-full justify-end">
                <div className="relative">
                    <Input placeholder="Search for Admins" className="pl-8 placeholder:text-slate-400" />
                ...
                <TableBody>
                    {admins.map((user) => (
                        <TableRow>
                            ...
                            <TableCell>{user.email}</TableCell>
                            <TableCell>
                                <XMarkIcon className="cursor-pointer" color="red" height="2em" />
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
...
function AllUsers() {
    return (
        <div className="flex flex-col gap-4 py-4">
            <div className="flex gap-x-2 w-full justify-end">
                <div className="relative">
                    <Input placeholder="Search for Users" className="pl-8 placeholder:text-slate-400" />
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <MagnifyingGlassIcon height="1em" className="inline-block text-slate-400" />
                    </div>
                </div>
                ...
                <TableBody>
                    {users.map((user) => (
                        <TableRow>
                            ...
                            <TableCell>{user.email}</TableCell>
                            <TableCell>
                                <PencilIcon className="cursor-pointer" height="2em" />
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
