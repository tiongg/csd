...
export function DesmosLaunchTile() {
  ...
  return (
    <Link
      ...
      title="Open Desmos"
      className="group relative flex h-24 w-full min-w-0 items-center overflow-hidden rounded-[24px] border border-slate-300 bg-white/85 px-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.82),0_0_0_1px_rgba(226,232,240,0.9)] transition-[transform,border-color,box-shadow,background-color] duration-200 hover:border-sky-300/80 hover:bg-white focus-visible:-translate-y-0.5 focus-visible:border-sky-300/80 focus-visible:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-200"
    >
